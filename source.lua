...
Miscenalleous = Tabs.Misc:AddLeftGroupbox("Miscenalleous")
SilentAim = Tabs.Misc:AddRightGroupbox("Silent Aim")
Movement = Tabs.Misc:AddRightGroupbox("Movement")
Effects = Tabs.Visuals:AddLeftGroupbox("Effects")
...
local function LatestBindHitmarker(Tool)
    ...
    LatestHitmarkerConnections[Tool] = Signal:Connect(function(Target)
        if miscenalleous.hitsound then
